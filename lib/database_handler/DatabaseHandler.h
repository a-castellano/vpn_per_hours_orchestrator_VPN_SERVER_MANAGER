...
public:
  DatabaseHandler(const std::string &, const unsigned int &,
  ...
  boost::shared_ptr<std::string> setServerName(boost::shared_ptr<std::string>,
                                               const unsigned int &);
  ...
  bool getVPNUserPassword(const unsigned int &, std::string *, std::string *);
